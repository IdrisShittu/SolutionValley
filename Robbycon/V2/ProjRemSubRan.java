...
public class ProjRemSubRan{
 ...
 System.exit( 0 );
	...
	public static void main (String args[]){
		String res; int count; int b; char con='1'; long resulti,resultj,comb=0;int conn;
		
	int len=Integer.parseInt(JOptionPane.showInputDialog("enter length:"));
	int low=Integer.parseInt(JOptionPane.showInputDialog("enter the lower bound of the random no's:"));
	int high=Integer.parseInt(JOptionPane.showInputDialog("enter the upper bound of the random no's:"));
    long[] A = new long [len+1];
    
    for(int i=0;i<len;i++){
    			A[i]=(int)(1+Math.random()*high)-low;
